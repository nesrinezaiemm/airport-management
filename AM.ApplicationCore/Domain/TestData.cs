...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Plane Airbusplane = new Plane { PlaneType = PlaneType.Airubus, capacity = 250, ManufactureDate = new DateTime(2020, 11, 11) };
        // Staffs
       ...
       ,
        ...
        public static Flight flight6 = new Flight { FlightDate = new DateTime(2022, 06, 01, 20, 10, 10), Destination = "Lisbonne", EffectiveArrival = new DateTime(2022, 06, 01, 22, 30, 10), EstimatedDuration = 200, plane = Airbusplane, Departure="nesrine", Airline="PARIS" };
